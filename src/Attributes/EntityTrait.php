<?php namespace Laradic\Admin\Attributes;
...
use Exception;
use Laradic\Admin\Attributes\Relations\EavValues;
...
trait EntityTrait
{
     ...
     *
     * @return \Laradic\Admin\Attributes\Value
     */
    public function values()
    {
        return $this->hasValues('Laradic\Admin\Attributes\Value', 'entity');
    }
     ...
     * @param  string $key
     * @param  mixed  $value
     * @return \Laradic\Admin\Attributes\Value|bool
     */
     ...
     *
     * @param  \Laradic\Admin\Attributes\Value $valueInstance
     * @param  mixed                           $value
     * @return \Laradic\Admin\Attributes\Value|bool
     */
     ...
     *
     * @param  string $key
     * @return \Laradic\Admin\Attributes\Attribute
     */
